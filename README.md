...
> 34 tools across the full POEditor v2 API. Manage projects, terms, translations, contributors, and languages. Auto-translate with Google, Microsoft, or DeepL. Export to any format your client supports. OAuth 2.1 with PKCE.
...
| **Translations** | commit, propose, update, delete, fill from TM, list fuzzy, list pending proofread, list untranslated |
...
- Full POEditor v2 API coverage (34 tools)
